...
public class ResumoLancamento {
    ...
    public ResumoLancamento(Long codigo, String descricao, LocalDate dataVencimento, LocalDate dataPagamento, BigDecimal valor, TipoLancamento lancamento, String categoria, String pessoa) {
        this.codigo = codigo;
